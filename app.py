...
class SimulatedRobot:
    ...
    def backward(self):
        ...
        print("⬅️ Robot indietro")  # Stampa il comando

    def left(self):
        self.status = "turning left"  # Cambia lo stato a "gira a sinistra"
        print("↩️ Robot gira a sinistra")  # Stampa il comando

    def right(self):
        self.status = "turning right"  # Cambia lo stato a "gira a destra"
        print("↪️ Robot gira a destra")  # Stampa il comando

    def stop(self):
        self.status = "stopped"  # Cambia lo stato a "fermo"
        print("⏹️ Robot fermo")  # Stampa il comando
